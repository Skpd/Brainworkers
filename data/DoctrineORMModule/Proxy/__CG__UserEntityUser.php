...
class User extends \User\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'username', 'email', 'displayName', 'password', 'salt', 'state', 'userRoles', 'answer', 'surname', 'name', 'patronymic', 'created', 'updated', 'gender', 'city', 'region', 'country');
        }
    ...
    public function removeUserRoles($roles)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeUserRoles', array($roles));

        return parent::removeUserRoles($roles);
    }
    ...
    public function setUserRoles($user_roles)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserRoles', array($user_roles));
